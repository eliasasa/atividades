...
def doces():
    ...
    iconl = ctk.CTkLabel(frame1, image=icon1, text='7belo sabor body splash -\nR$ 20,00\n\n\n\n', font=('Arial', 25, 'bold'), text_color='red')
    ...
    iconl2 = ctk.CTkLabel(frame2, image=icon2, text='Dormec (pacote) -\nR$ 16,50\n\n\n\n', font=('Arial', 25, 'bold'), text_color='black')
    ...
    iconl2 = ctk.CTkLabel(frame3, image=icon3, text='KitKat frutos do mar -\nR$ 20,00\n\n\n\n', font=('Arial', 25, 'bold'), text_color='black')
    iconl2.place(relx=0.5, rely=0.4, anchor='center')
    ...
    iconl2 = ctk.CTkLabel(frame4, image=icon4, text='Fatia Bolo Shrek - \nR$ 8,50\n\n\n\n', font=('Arial', 25, 'bold'), text_color='black')
    iconl2.place(relx=0.5, rely=0.4, anchor='center')
    ...
    iconl2 = ctk.CTkLabel(frame5, image=icon5, text='Sorvete de lula -\nR$ 7,00\n\n\n\n', font=('Arial', 25, 'bold'), text_color='black')
    iconl2.place(relx=0.5, rely=0.4, anchor='center')
    ...
    iconl2 = ctk.CTkLabel(frame6, image=icon6, text='Pasta Tandy Vários sabores -\nR$ 9,50\n\n\n\n', font=('Arial', 25, 'bold'), text_color='black')
    iconl2.place(relx=0.5, rely=0.4, anchor='center')
...
def drinks():
    ...
    icon1 = ImageTk.PhotoImage(icon1)
    iconl = ctk.CTkLabel(frame1, image=icon1, text='Leninade ☭ - R$ 15,00\n\n\n\n\n', font=('Arial', 25, 'bold'), text_color='black')
    iconl.place(relx=0.5, rely=0.4, anchor='center')
    ...
    icon2 = ImageTk.PhotoImage(icon2)
    iconl2 = ctk.CTkLabel(frame2, image=icon2, text='Seda sabor Mel -\nR$ 11,50\n\n\n\n', font=('Arial', 25, 'bold'), text_color='black')
    iconl2.place(relx=0.5, rely=0.4, anchor='center')
    ...
    icon3 = ImageTk.PhotoImage(icon3)
    iconl2 = ctk.CTkLabel(frame3, image=icon3, text='Qboa - R$ 20,00\n\n\n\n\n', font=('Arial', 25, 'bold'), text_color='black')
    iconl2.place(relx=0.5, rely=0.4, anchor='center')
    bt_buy(frame3, 'Qboa')
    ...
    icon4 = ImageTk.PhotoImage(icon4)
    iconl2 = ctk.CTkLabel(frame4, image=icon4, text='Coca-Cola sabor Ebola - \nR$ 13,50\n\n\n\n', font=('Arial', 25, 'bold'), text_color='white')
    iconl2.place(relx=0.5, rely=0.4, anchor='center')
    ...
    icon5 = ImageTk.PhotoImage(icon5)
    iconl2 = ctk.CTkLabel(frame5, image=icon5, text='Poção de Cura -\nR$ 25,00\n\n\n\n', font=('Arial', 25, 'bold'), text_color='black')
    iconl2.place(relx=0.5, rely=0.4, anchor='center')
    ...
    icon6 = ImageTk.PhotoImage(icon6)
    iconl2 = ctk.CTkLabel(frame6, image=icon6, text='Perfume do Palmeiras \nJequiti - R$ 30,00\n\n\n\n', font=('Arial', 25, 'bold'), text_color='black')
    iconl2.place(relx=0.5, rely=0.4, anchor='center')
...
def comidas():
    ...
    icon2 = ImageTk.PhotoImage(icon2)
    iconl2 = ctk.CTkLabel(frame2, image=icon2, text='Múmia Mexicana - \nR$ 40,00\n\n\n\n', font=('Arial', 25, 'bold'), text_color='black')
    iconl2.place(relx=0.5, rely=0.4, anchor='center')
    ...
    icon3 = ImageTk.PhotoImage(icon3)
    iconl2 = ctk.CTkLabel(frame3, image=icon3, text='Fabio & Nuggets - R$ 35,00\n\n\n\n\n', font=('Arial', 25, 'bold'), text_color='black')
    iconl2.place(relx=0.5, rely=0.4, anchor='center')
    ...
    icon4 = ImageTk.PhotoImage(icon4)
    iconl2 = ctk.CTkLabel(frame4, image=icon4, text='Pseudo Sushi - \nR$ 0,50 (peça)\n\n\n\n', font=('Arial', 25, 'bold'), text_color='black')
    iconl2.place(relx=0.5, rely=0.4, anchor='center')
    ...
    icon5 = ImageTk.PhotoImage(icon5)
    iconl2 = ctk.CTkLabel(frame5, image=icon5, text='Sobras do Pablo Marçal - \nR$ 100,00\n\n\n\n', font=('Arial', 25, 'bold'), text_color='black')
    iconl2.place(relx=0.5, rely=0.4, anchor='center')
    ...
    icon6 = ImageTk.PhotoImage(icon6)
    iconl2 = ctk.CTkLabel(frame6, image=icon6, text='Provavelmente comida - \nR$ 25,00\n\n\n\n', font=('Arial', 25, 'bold'), text_color='black')
    iconl2.place(relx=0.5, rely=0.4, anchor='center')
